...
#[derive(Debug, Copy, Clone)]
pub struct Proc {
    pub p_pid: PidT,                        // process ID
    pub p_gpid: PidT,                       // process group
    pub program_break: usize,               // process's program breakpoint
    pub original_break: usize,              // process's program breakpoint
    pub p_registers: x86_64_registers,      // process's current registers
    pub p_state: ProcstateT,                // process state (see above)
    pub p_pagetable: *mut x86_64_pagetable, // process's page table
